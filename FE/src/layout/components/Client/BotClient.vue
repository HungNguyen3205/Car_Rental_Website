<template>
  <div class="bot-client">
    ...
    <div class="chatbot-widget card" :class="{ 'widget-open': isOpen }">
      ...
      <div class="chat-body">
        <div class="msg ai">
          <div class="msg-content">Xin chào! 👋 Tôi là trợ lý AI ảo của hệ thống. Tôi có thể giúp gì cho quá trình thuê xe của bạn?</div>
